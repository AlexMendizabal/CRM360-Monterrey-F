...
export class LogisticaTipoMotoristaListaComponent implements OnInit, OnDestroy {
  ...
  changeType(tipoMotorista: ILogisticaTipoMotorista) {
  ...
  openRegister(tipoMotorista: ILogisticaTipoMotorista) {
