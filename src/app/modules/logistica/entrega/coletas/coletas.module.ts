...
import { AccordionModule, defineLocale, ProgressbarModule, ptBrLocale } from 'ngx-bootstrap';
...
import { LogisticaEntregaColetasRoutingModule } from './coletas-routing.module';
...
export class LogisticaColetasModule { }
