...
@Component({
  selector: 'comercial-ciclo-vendas-Autorizaciones',
  templateUrl: './autorizaciones.component.html',
  styleUrls: ['./autorizaciones.component.scss'],
})
export class ComercialCicloVendasAutorizacionesComponent
  implements OnInit {
  ...
  constructor(
    ...
    private autorizacionesService: ComercialCicloVendasAutorizacionesService,
