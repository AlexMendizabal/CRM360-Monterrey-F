...
@Component({
    selector:
        'comercial-ciclo-vendas-cotacoes-formulario-modal-material-autorizacion',
    templateUrl: './autorizacion.component.html',
    styleUrls: ['./autorizacion.component.scss'],
})
export class ComercialCicloVendasCotacoesFormularioModalMaterialAutorizacionComponent
    implements OnInit {
    @Input('oferta') params: any;
