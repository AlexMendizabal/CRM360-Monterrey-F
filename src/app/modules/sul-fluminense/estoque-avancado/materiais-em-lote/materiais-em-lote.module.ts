...
import { SulFluminenseEstoqueAvancadoMateriaisEmLoteRoutingModule } from './materiais-em-lote-routing.module';
...
@NgModule({
  declarations: [SulFluminenseEstoqueAvancadoMateriaisEmLoteComponent],
  imports: [
    CommonModule,
...
export class SulFluminenseEstoqueAvancadoMateriaisEmLoteModule { }
