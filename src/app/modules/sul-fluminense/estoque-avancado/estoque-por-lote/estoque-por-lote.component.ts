...
import { SulFluminenseEstoqueAvancadoEstoquePorLoteService } from '../services/estoque-por-lote.service';
import { SulFluminenseEstoqueAvancadoGenericService } from '../services/generic.service';

@Component({
  selector: 'estoque-por-lote',
  templateUrl: './estoque-por-lote.component.html',
  styleUrls: ['./estoque-por-lote.component.scss']
})
export class SulFluminenseEstoqueAvancadoEstoquePorLoteComponent implements OnInit, OnDestroy {
  ...
  appTitle = 'Auditoria Estoque por Lote';
  ...
  constructor(
    private service: SulFluminenseEstoqueAvancadoEstoquePorLoteService,
