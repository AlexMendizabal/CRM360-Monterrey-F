...
import { SulFluminenseEstoqueAvancadoEstoqueDeFaturamentoService } from '../services/estoque-de-faturamento.service';
import { SulFluminenseEstoqueAvancadoGenericService } from '../services/generic.service';

@Component({
  selector: 'estoque-de-faturamento',
  templateUrl: './estoque-de-faturamento.component.html',
  styleUrls: ['./estoque-de-faturamento.component.scss']
})
export class SulFluminenseEstoqueAvancadoEstoqueDeFaturamentoComponent implements OnInit, OnDestroy {
  ...
  appTitle = 'Auditoria Estoque de Faturamento';
  ...
  constructor(
    private service: SulFluminenseEstoqueAvancadoEstoqueDeFaturamentoService,
