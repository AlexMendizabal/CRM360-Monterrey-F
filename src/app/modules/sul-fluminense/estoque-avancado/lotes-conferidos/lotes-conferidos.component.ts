...
import { SulFluminenseEstoqueAvancadoLotesConferidosService } from '../services/lotes-conferidos.service';

@Component({
  selector: 'lotes-conferidos',
  templateUrl: './lotes-conferidos.component.html',
  styleUrls: ['./lotes-conferidos.component.scss']
})
export class SulFluminenseEstoqueAvancadoLotesConferidosComponent implements OnInit, OnDestroy {
  ...
  appTitle = 'Auditoria Lotes Conferidos';
  ...
  constructor(
    private service: SulFluminenseEstoqueAvancadoLotesConferidosService,
    ...
    this.form = this.formBuilder.group({
      DT_INIC_ENTR: [this.dateService.getFirstDayMonth(), Validators.required],
      DT_FINA_ENTR: [this.data, Validators.required],
      DT_INIC_CONF: [this.dateService.getFirstDayMonth(), Validators.required],
      DT_FINA_CONF: [this.data, Validators.required],
      ID_LINH: [null],
      ID_CLAS: [null],
      ID_MATE: [null],
      CD_LOTE: [null],
