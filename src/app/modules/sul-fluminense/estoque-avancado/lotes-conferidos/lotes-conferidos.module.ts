...
import { SulFluminenseEstoqueAvancadoLotesConferidosRoutingModule } from './lotes-conferidos-routing.module';
...
@NgModule({
  declarations: [SulFluminenseEstoqueAvancadoLotesConferidosComponent],
  imports: [
    CommonModule,
...
export class SulFluminenseEstoqueAvancadoLotesConferidosModule { }
